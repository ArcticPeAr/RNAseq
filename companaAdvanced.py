...
if 'usVerInput2' not in locals() and usVerInput1 != "all":
...
for item in StrList:
    versus = item
    if usVerInput1 != "all" and versus != iniVersus:
        pass
    ...
    print('Before analysis begins, please select what output you want, separated by space:)
    userInputMain = input('Before analysis begins, please select what output you want, separated by space:\n 1. to print the Up and Down - lists type: "lists"\n 2. GO enrichment type: "GO"\n')
    
    MainUserInput = input('following options available: \n 1. to print the lists type:  \n 2. GO enrichment')
