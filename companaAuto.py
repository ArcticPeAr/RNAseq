...
######################################################################################################
    ...
    if userinputFC == "yes" or userinputFC == "y":
       ...
       # FullPandas["UP"] = flatUPsansNA2
       # FullPandas["DOWN"] = flatDOWNsansNA2

#save the full pandas dataframe
    #FullPandas.to_excel(filename2, sheet_name='UPandDOWN', index=False, header=True, startrow=0, startcol=0, engine='xlsxwriter')
